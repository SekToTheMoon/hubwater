...
`,
    ...
    doc.fontSize(15).text("ต้นฉบับ", 360, 60, { width: 150, align: "center" });
    ...
    doc.text("เลขประจำตัวผู้เสียภาษี " + customer.customer_nid, leftSide, 176);
    doc.text(
    ...
    doc.text("เลขล็อต", xPositions[2], y + 2, { width: 140, align: "center" });
    ...
    if (!id.startsWith("QT")) {
      ...
      doc.fontSize(15).text("สำเนา", 360, 60, { width: 150, align: "center" });
